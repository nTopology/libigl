...
public:
  ...
  inline void solve(
    ...
    Vecd&      _rhs, 
    Veci&      _to_round,
    bool       _fixed_order = false ,NTInterrupter* interrupter = nullptr );
...
private:
  ...
  void solve_multiple_rounding( 
    ...
    Vecd&      _x, 
    Vecd&      _rhs, 
    Veci&      _to_round,NTInterrupter* interrupter = nullptr);
...
void update_solution( 
    ...
    Vecd&      _x, 
    Vecd&      _rhs, 
    Vecui&     _neigh_i,NTInterrupter* interrupter = nullptr );
